...
const StudentsPage = () => {
  return (
    <>
      ...
      <div className={styles.studentsDiv1}>
        <div className={`${styles.potter} ${styles.studentCard}`}>
          <h3>Harry Potter</h3>
          <p>
            The Boy Who Lived
            <br /> Gryffindor
        ...
        <div className={`${styles.granger} ${styles.studentCard}`}>
        ...
        <div className={`${styles.weasley} ${styles.studentCard}`}>
          <h3>Ron Weasley</h3>{' '}
          <p>
            Dragomir Despard <br />
            Gryffindor <br />
        ...
        <div className={`${styles.malfoy} ${styles.studentCard}`}>
          <h3>Draco Malfoy</h3>{' '}
          <p>
            Pure-blood <br />
            Slytherin <br />
      ...
      <div className={styles.studentsDiv2}>
        <div className={`${styles.diggory} ${styles.studentCard}`}>
        ...
        <div className={`${styles.chang} ${styles.studentCard}`}>
          <h3>Cho Chang</h3>{' '}
          <p>
            Seeker <br />
            Ravenclaw <br />
        ...
        <div className={`${styles.longbottom} ${styles.studentCard}`}>
        ...
        <div className={`${styles.lovegood} ${styles.studentCard}`}>
          <h3>Luna Lovegood</h3>{' '}
          <p>
            Née Lovegood <br />
            Ravenclaw <br />
